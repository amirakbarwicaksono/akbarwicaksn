        ...
        experiences: [
            {
                ...
                images: [ // optional: leave the array empty if you don't want to display images
                    {
                        src: '/images/projects/project-01/cover_05.PNG',
                        alt: 'Once UI Project',
                        width: 16,
                        height: 9
                    }
    ...
    technical: {
        ...
        skills: [
            ...
            },
            {
                ...
                images: [
                    {
                        src: '/images/projects/project-01/cover_06.jpg',
                        alt: 'Project image',
                        width: 16,
                        height: 9
                    },
                    {
                        src: '/images/projects/project-01/cover_07.jpg',
                        alt: 'Project image',
                        width: 16,
                        height: 9
                    },
                    {
                        src: '/images/projects/project-01/cover_08.jpg',
                        alt: 'Project image',
                        width: 16,
                        height: 9
                    },
